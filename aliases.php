...
// Maps old App\Services\Ontology\Parsers\Handlers\TurtleHandler to the new
// Youri\vandenBogert\Software\ParserTurtle\TurtleHandler class.
...
spl_autoload_register(function (string $class): void {
    ...
    $aliases = [
        'App\Services\Ontology\Parsers\Handlers\TurtleHandler' => \Youri\vandenBogert\Software\ParserTurtle\TurtleHandler::class,
    ];
